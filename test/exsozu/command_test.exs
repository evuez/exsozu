defmodule ExSozu.CommandTest do
  ...
  test "add_http_front/4 returns a valid command" do
    assert fetch_asset!("add_http_front") ==
             execute(:add_http_front, ["xxx", "yyy", "xxx"])
  end

  test "add_https_front/5 returns a valid command" do
    assert fetch_asset!("add_https_front") ==
             execute(:add_https_front, [
               "xxx",
               "yyy",
               "xxx",
  ...
  test "remove_certificate/2 returns a valid command" do
    assert fetch_asset!("remove_certificate") ==
             execute(:remove_certificate, [
               "ab2618b674e15243fd02a5618c66509e4840ba60e7d64cebec84cdbfeceee0c5"
             ])
  end

  test "remove_http_front/4 returns a valid command" do
    assert fetch_asset!("remove_http_front") ==
             execute(:remove_http_front, ["xxx", "yyy", "xxx"])
  end

  test "remove_https_front/5 returns a valid command" do
    assert fetch_asset!("remove_https_front") ==
             execute(:remove_https_front, [
               "xxx",
               "yyy",
               "xxx",
               "ab2618b674e15243fd02a5618c66509e4840ba60e7d64cebec84cdbfeceee0c5"
