defmodule ExSozu.CommandTest do
  ...
  test "add_certificate/4 returns a valid command" do
    ...
    assert fetch_asset!("add_certificate")
             == execute_multi(:add_certificate, ["-----BEGIN CERTIFICATE-----\\nXmNFv7LrfHj+sUmJnu6ZRwWhtF8RTjBgNOwEqf+lDSYkg3Y3giVzzO3v\n-----END CERTIFICATE-----\n",
                                                 ["-----BEGIN CERTIFICATE-----\\nXmNFv7LrfHj+sUmJnu6ZRwWhtF8RTjBgNOwEqf+lDSYkg3Y3giVzzO3v\n-----END CERTIFICATE-----",
                                                  "-----BEGIN CERTIFICATE-----\\nXmNFv7LrfHj+sUmJnu6ZRwWhtF8RTjBgNOwEqf+lDSYkg3Y3giVzzO3v\n-----END CERTIFICATE-----"],
                                                 "-----BEGIN RSA PRIVATE KEY-----\\n-----END RSA PRIVATE KEY-----\n"])
  end
  ...
  test "add_http_front/4 returns a valid command" do
    ...
    assert fetch_asset!("add_http_front") == execute_multi(:add_http_front, ["xxx", "yyy", "xxx"])
  end
  ...
  test "add_https_front/5 returns a valid command" do
    ...
    assert fetch_asset!("add_https_front") == execute_multi(:add_https_front, ["xxx",
                                                                               "yyy",
                                                                               "xxx",
                                                                               "ab2618b674e15243fd02a5618c66509e4840ba60e7d64cebec84cdbfeceee0c5"])
  end
  ...
  test "remove_certificate/2 returns a valid command" do
    ...
    assert fetch_asset!("remove_certificate") == execute_multi(:remove_certificate, ["ab2618b674e15243fd02a5618c66509e4840ba60e7d64cebec84cdbfeceee0c5"])
  end
  ...
  test "remove_http_front/4 returns a valid command" do
    ...
    assert fetch_asset!("remove_http_front") == execute_multi(:remove_http_front, ["xxx", "yyy", "xxx"])
  end
  ...
  test "remove_https_front/5 returns a valid command" do
    ...
    assert fetch_asset!("remove_https_front") == execute_multi(:remove_https_front, ["xxx", "yyy", "xxx", "ab2618b674e15243fd02a5618c66509e4840ba60e7d64cebec84cdbfeceee0c5"])
  end

  test "remove_instance/4 returns a valid command" do
    assert fetch_asset!("remove_instance") == execute(:remove_instance, ["xxx", "127.0.0.1", 8080])
    assert fetch_asset!("remove_instance") == execute_multi(:remove_instance, ["xxx", "127.0.0.1", 8080])
  end

  test "save_state/2 returns a valid command" do
    assert fetch_asset!("save_state") == execute(:save_state, ["./config_dump.json"])
    assert fetch_asset!("save_state") == execute_multi(:save_state, ["./config_dump.json"])
  end

  test "soft_stop/1 returns a valid command" do
    assert fetch_asset!("soft_stop") == execute(:soft_stop, [[proxy_id: 0]])
    assert fetch_asset!("soft_stop") == execute_multi(:soft_stop, [[proxy_id: 0]])
  end

  test "status/1 returns a valid command" do
    assert fetch_asset!("status") == execute(:status, [[proxy_id: 0]])
    assert fetch_asset!("status") == execute_multi(:status, [[proxy_id: 0]])
  end

  test "upgrade_master/1 returns a valid command" do
    assert fetch_asset!("upgrade_master") == execute(:upgrade_master)
    assert fetch_asset!("upgrade_master") == execute_multi(:upgrade_master)
  end
end
